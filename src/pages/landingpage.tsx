...
const Landingpage = () => {
  ...
  const [hp, setHp] = useState<React.CSSProperties>({
    position: "inherit",
  });
  ...
  return (
    <motion.div className={styles.main} ref={parent}>
      <Head>
      ...
      <motion.header
        ...
        style={{position: scrolly > 0 ? "fixed" : "relative", transition: "ease-in-out"}}
      >
        <div style={{ display: "flex" }}>
          <div className={styles["menu-toggler"]}>
            <Anchor open={modal} navlinks={navLinks} anchor="left" />
          </div>
